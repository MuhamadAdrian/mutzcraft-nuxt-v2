			...
			>
				...
				<transition name="layout" mode="out-in">
					...
					>
						<li>
							<nuxt-link
								class="mobile py-3 pl-10 pr-4 text-sm text-gray-600 flex items-center rounded-md hover:bg-gray-100 dark:hover:bg-gray-800 dark:text-gray-200 transition-colors duration-300"
								to="/admin/profile"
							>
								<svg
									class="fill-current"
